...
def visualize_joints_in_rgb(images,intrinsics,mano_pose, mano_betas, mano_side, out_dir:str = "tmp",ind=0,ext=None) -> None:
    os.makedirs(out_dir, exist_ok=True)
    vertices, faces = get_vertices_faces(mano_pose, mano_betas,mano_side,ext)
...
if __name__ == '__main__':
    ...
    # cam_list = ['400002', '400004', '400006', '400008', '400009', '400010', '400012', '400013', '400015', '400016', '400017', '400018', '400019', '400023', '400026', '400027', '400028', '400029', '400030', '400031', '400035', '400037', '400039', '400041', '400042', '400048', '400049', '400051', '400053', '400059', '400060', '400063', '400064', '410001', '410003', '410004', '410014', '410015', '410018', '410019', '410027', '410028', '410029', '410033', '410049', '410050', '410053', '410057', '410061', '410062', '410063', '410066', '410067', '410068', '410069', '410208', '410210', '410211', '410213', '410214', '410215', '410216', '410218', '410219', '410220', '410226', '410229', '410231', '410232', '410234', '410236', '410237', '410238']
    ...
    picked_camera = 'cam400030'
    picked_camera_id = 400030
    picked_capture = 'Capture3'
    picked_split = 'train'
    picked_capture_id = 3
    ...
    # breakpoint()
    with open(os.path.join(interhand_anno_dir, picked_split, 'InterHand2.6M_train_MANO_NeuralAnnot.json')) as f:
        mano_data = json.load(f)
    with open(os.path.join(interhand_anno_dir, picked_split, 'InterHand2.6M_train_camera.json')) as f:
        camera_data = json.load(f)
    with open(os.path.join(interhand_anno_dir, picked_split, 'InterHand2.6M_train_joint_3d.json')) as f:
    ...
    # breakpoint()
    for img_path in tqdm(this_seq[:5]):
        ...
        img = iio.imread(os.path.join(picked_split_root, img_path))
